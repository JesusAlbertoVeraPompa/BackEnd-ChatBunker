...
class UserSearchView(APIView):
    ...
    Permite a cualquier usuario autenticado buscar a otros usuarios por email (búsqueda parcial).
    Retorna información limitada (id, email, full_name).
    Excluye al propio usuario de la búsqueda.
    """
