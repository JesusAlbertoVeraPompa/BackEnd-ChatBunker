...
# ─────────────────────────────────────────
# CORS & CSRF (Configuración Crítica para GitHub Pages)
# ─────────────────────────────────────────
# Extraemos los orígenes permitidos
...
# Añadimos también a orígenes confiables para CSRF (Obligatorio en Django 4+)
